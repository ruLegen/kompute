...
// Make sure the logger is setup
        ...
        this->setupAllocator(this->mInstance, this->mPhysicalDevice, this->mDevice);
    }
...
// Make sure the logger is setup
    ...
    void Manager::setupAllocator(std::shared_ptr<vk::Instance> instance,
                                 std::shared_ptr<vk::PhysicalDevice> physicalDevice,
                                 std::shared_ptr<vk::Device> device) {


        VmaVulkanFunctions vulkanFunctions = getVMAFunctions();

        VmaAllocatorCreateInfo allocatorCreateInfo = {};
        allocatorCreateInfo.vulkanApiVersion = VK_API_VERSION_1_0;
        allocatorCreateInfo.physicalDevice = (VkPhysicalDevice) (*physicalDevice);
    ...
    VmaVulkanFunctions Manager::getVMAFunctions() {
